...
Приложения для воспроизведения аудиофайлов из файловой системы.
...
При клике на любой трек из списка - запускается экран с выбранным треком. Аудиофайлы запускаюся благодаря **MediaPlayer**'у и работе **BoundService**.  
